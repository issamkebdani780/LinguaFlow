import { BrainCircuit, Mic, Database, ArrowRight } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              ...
              <span className="bg-gradient-to-r from-sky-400 to-indigo-400 bg-clip-text text-transparent">speak confidently.</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 md:row-span-2 bg-gradient-to-b from-[#1A1D24]/60 to-[#111318]/80 backdrop-blur-md border border-white/10 rounded-3xl p-8 relative overflow-hidden group hover:border-sky-400/30 hover:-translate-y-1 transition-all">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400 mb-6 max-w-md">We use the Ebbinghaus Forgetting Curve algorithm. The AI schedules reviews for each word specifically based on your performance.</p>
            ...
            <div className="bg-gradient-to-b from-[#1A1D24]/60 to-[#111318]/80 backdrop-blur-md border border-white/10 rounded-3xl p-6 hover:border-sky-400/30 hover:-translate-y-1 transition-all">
              ...
              <h3 className="text-xl font-bold mb-2">Voice Analysis</h3>
              <p className="text-sm text-gray-400">Send voice notes. The AI checks pronunciation and gives instant feedback.</p>
            </div>
            
            <div className="bg-gradient-to-b from-[#1A1D24]/60 to-[#111318]/80 backdrop-blur-md border border-white/10 rounded-3xl p-6 hover:border-sky-400/30 hover:-translate-y-1 transition-all">
              <Database className="w-8 h-8 text-green-400 mb-4" />
              <h3 className="text-xl font-bold mb-2">Infinite Vocabulary</h3>
              <p className="text-sm text-gray-400">Store thousands of words. Search, filter, and export your personal dictionary anytime.</p>
            </div>
            ...
            <div className="md:col-span-3 bg-gradient-to-b from-[#1A1D24]/60 to-[#111318]/80 backdrop-blur-md border border-white/10 rounded-3xl p-8 flex flex-col md:flex-row items-center gap-8 hover:border-sky-400/30 hover:-translate-y-1 transition-all">
              <div className="flex-1">
                ...
                <p className="text-gray-400">The AI adapts examples to your region and career, whether you are an Arabic speaker in Algeria or a global professional.</p>
              </div>
              <div className="flex gap-4 items-center">
                <div className="px-4 py-2 rounded-lg bg-[#0B0C10] border border-white/10 text-sm flex items-center gap-2">
                  <span className="text-xs bg-sky-500/20 text-sky-300 px-1.5 py-0.5 rounded">EN</span>
                  Entrepreneur
                </div>
                <ArrowRight className="text-gray-600" />
                <div className="px-4 py-2 rounded-lg bg-[#0B0C10] border border-white/10 text-sm flex items-center gap-2">
                  <span className="text-xs bg-green-500/20 text-green-300 px-1.5 py-0.5 rounded">AR</span>
                  رائد أعمال
                </div>
              </div>
            </div>
